...
public class EventListenerLoader : IEventListenerLoader
{
    ...
    [
        ...
        new AllyActionEvent([ActionIds.Contradance],
            ...
            "AllyDncLBEvent"),
        new AllyActionEvent([ActionIds.Flarethrower], [StartedFire], "Flarethrower (Rival Wings)",
            "AllyFlarethrowerEvent"),
        new EnemyActionEvent([ActionIds.Flarethrower], [StartedFire], [], "Enemy Flarethrower (Rival Wings)",
        ...
        new AllyActionEvent([
            ...
            [BannedCompoundRobot, VFWickedWeapon, UnusedOhMercyFem, UnusedNoRespectMasc, Hahahahahaha], "Instant Kills",
