...
// === Intro Lines ===
    ...
    public static readonly BattleTalk UnusedNoRespectMasc = new BattleTalk(Metem,  8205372, 4, InternalConstants.NoRespectText, [Personalization.MascPronouns, Personalization.MetemAnnouncer], MetemI); // This man has absolutely no respect for the rules! - 
    public static readonly BattleTalk UnusedUpOnThePost = new BattleTalk(Metem,  8205373, 3, InternalConstants.UpOnThePostText, [Personalization.MascPronouns, Personalization.MetemAnnouncer], MetemI); // He's up on the post! You know what that means... 
    public static readonly BattleTalk UnusedBombarianPress = new BattleTalk(Metem,  8205374, 3, InternalConstants.BombarianPressText, [Personalization.MetemAnnouncer], MetemI); // It's the Bombarian press! 
    public static readonly BattleTalk UnusedOhMercyFem = new BattleTalk(Metem,  8205359, 4, InternalConstants.OhMercyText, [Personalization.FemPronouns, Personalization.MetemAnnouncer], MetemI); // Oh mercy is she doing what I think she's doing?
    public static readonly BattleTalk UnusedBackTail = new BattleTalk(Metem,  8206126, 5, InternalConstants.BackTailText, [Personalization.MetemAnnouncer], MetemI); // Yes! You've got the serpent on the back tail! Press the advantage and finish this!
    // ==

    // MAHJONG
    public static readonly BattleTalk MjGameChanger = new BattleTalk(Metem,  8291277, 3, InternalConstants.MjTextGameChanger, [Personalization.MetemAnnouncer], MetemI); // This could be a real game changer.
    public static readonly BattleTalk MjBoldMove = new BattleTalk(Metem,  8291276, 4, InternalConstants.MjTextBoldMove, [Personalization.MetemAnnouncer], MetemI); // A bold move from our challenger, but will it pay off?
    public static readonly BattleTalk MjChallengerRecover = new BattleTalk(Metem,  8291278, 4, InternalConstants.MjTextChallengerRecover, [Personalization.MetemAnnouncer], MetemI); // How will the challenger recover from this I wonder?
    public static readonly BattleTalk MjRivalVying = new BattleTalk(Metem,  8291279, 4, InternalConstants.MjTextRivalVying, [Personalization.MetemAnnouncer], MetemI); // Whats this? A rival vying for victory? 
    public static readonly BattleTalk MjHeatingUp = new BattleTalk(Metem,  8291280, 5, InternalConstants.MjTextHeatingUp, [Personalization.MetemAnnouncer], MetemI); // Things are really heating up. I can scarcely look away.
    public static readonly BattleTalk MjHandDecided = new BattleTalk(Metem,  8291281, 3, InternalConstants.MjTextHandDecided, [Personalization.MetemAnnouncer], MetemI); // There it is. The hand is decided.
    public static readonly BattleTalk MjKissLadyLuck = new BattleTalk(Metem,  8291282, 5, InternalConstants.MjTextKissLadyLuck, [Personalization.MetemAnnouncer], MetemI); // And with a kiss from lady luck, we have our winner.
    public static readonly BattleTalk MjGoodnessGracious = new BattleTalk(Metem,  8291283, 2, InternalConstants.MjTextGoodnessGracious, [Personalization.MetemAnnouncer], MetemI); // Oh goodness gracious me.
    public static readonly BattleTalk MjOurTile = new BattleTalk(Metem,  8291284, 4, InternalConstants.MjTextOurTile, [Personalization.MetemAnnouncer], MetemI); // That should have been our tile, the scoundrel.
    public static readonly BattleTalk MjPainfulToWatch = new BattleTalk(Metem,  8291285, 4, InternalConstants.MjTextPainfulToWatch, [Personalization.MetemAnnouncer], MetemI); // Oh the horror! It was too painful to watch.
    public static readonly BattleTalk MjClobberedWithTable = new BattleTalk(Metem,  8291286, 5, InternalConstants.MjTextClobberedTable, [Personalization.MetemAnnouncer], MetemI); // Ha! You all but clobbered them with the table that round.
    public static readonly BattleTalk MjBeautifullyPlayed = new BattleTalk(Metem,  8291287, 4, InternalConstants.MjTextBeautifullyPlayed, [Personalization.MetemAnnouncer], MetemI); // Beautifully played my friend, beautifully played.
    public static readonly BattleTalk MjMadeYourMark = new BattleTalk(Metem,  8291288, 4, InternalConstants.MjTextMadeYourMark, [Personalization.MetemAnnouncer], MetemI); // You certainly made your mark this round. Keep it up!
    public static readonly BattleTalk MjDontStandAChance = new BattleTalk(Metem,  8291289, 5, InternalConstants.MjTextDontStandAChance, [Personalization.MetemAnnouncer], MetemI); // Mmm, letting them think they stand a chance. I like it.
    public static readonly BattleTalk MjChallengerDownHardGentle = new BattleTalk(Metem,  8291290, 4, InternalConstants.MjTextChallengerDownHard, [Personalization.MetemAnnouncer], MetemI); // Oh my, our challenger went down hard.
    public static readonly BattleTalk MjStillInItGentle = new BattleTalk(Metem,  8291291, 4, InternalConstants.MjTextStillInIt, [Personalization.MetemAnnouncer], MetemI); // Our challenger is still in it! But for how long?  
    public static readonly BattleTalk MjStillStandingGentle = new BattleTalk(Metem,  8291292, 5, InternalConstants.MjTextStillStanding, [Personalization.MetemAnnouncer], MetemI); // Ooh even I felt that one, but our challenger is still standing. 
    public static readonly BattleTalk MjDownNotOut = new BattleTalk(Metem,  8291293, 4, InternalConstants.MjTextDownNotOut, [Personalization.MetemAnnouncer], MetemI); // Our challenger is down, but not out.
    public static readonly BattleTalk MjTitanOfTable = new BattleTalk(Metem,  8291294, 6, InternalConstants.MjTextTitanOfTable, [Personalization.MetemAnnouncer], MetemI); // The titan of the table, tactician of the tiles! Brilliantly Played.
    public static readonly BattleTalk MjCommendableEffort = new BattleTalk(Metem,  8291295, 4, InternalConstants.MjTextCommendableEffort, [Personalization.MetemAnnouncer], MetemI); // A commendable effort! You should be proud.
    public static readonly BattleTalk MjReportingLive = new BattleTalk(Metem,  8291296, 6, InternalConstants.MjTextReportingLive, [Personalization.MetemAnnouncer], MetemI); // This was Metem, reporting live from the Mahjong table. Thank you and good night.
    public static readonly BattleTalk MjCompetitionTooMuch = new BattleTalk(Metem,  8291297, 5, InternalConstants.MjTextCompetitionTooMuch, [Personalization.MetemAnnouncer], MetemI); // Was the competition simply too much for our challenger? I should hope not.
    public static readonly BattleTalk MjUtterlyHumiliated = new BattleTalk(Metem,  8291298, 6, InternalConstants.MjTextUtterlyHumiliated, [Personalization.MetemAnnouncer], MetemI); // Oh dear our challenger has been utterly humiliated! I fear this will haunt them...

    // m12sp2
    public static readonly BattleTalk LindwurmsHeart = new BattleTalk(Metem,  8206130, 4, InternalConstants.TextLindwurmsHeart, [Personalization.MetemAnnouncer, Personalization.President], MetemI); // Huh? Is it? The Lindwurm’s heart!?
    public static readonly BattleTalk BadFeeling = new BattleTalk(Metem,  8206131, 4, InternalConstants.TextBadFeeling, [Personalization.MetemAnnouncer], MetemI); // It’s pulsating… I’ve got a bad feeling about this!
    public static readonly BattleTalk Transforming = new BattleTalk(Metem,  8206132, 3, InternalConstants.TextTransforming, [Personalization.MetemAnnouncer], MetemI); // It’s contorted…transforming!
    public static readonly BattleTalk ItsAliveLindwurm = new BattleTalk(Metem,  8206133, 4, InternalConstants.TextItsAliveLindwurm, [Personalization.MetemAnnouncer, Personalization.President], MetemI); // It’s alive! It’s the birth of a new Lindwurm!
    public static readonly BattleTalk BattleNotOverDontDespair = new BattleTalk(Metem,  8206134, 5, InternalConstants.TextBattleNotOverDontDespair, [Personalization.MetemAnnouncer], MetemI); // Alas, the battle isn’t over yet, but don’t despair Champion!
    public static readonly BattleTalk CreatingMore = new BattleTalk(Metem,  8206135, 3, InternalConstants.TextCreatingMore, [Personalization.MetemAnnouncer, Personalization.President], MetemI); // The Lindwurm is creating more of itself!
    public static readonly BattleTalk ContinuesToMultiply = new BattleTalk(Metem,  8206136, 6, InternalConstants.TextContinuesToMultiply, [Personalization.MetemAnnouncer, Personalization.President], MetemI); // The Lindwurm continues to multiply! We’ve gone well beyond mortal limits now!
    public static readonly BattleTalk CuriousProps = new BattleTalk(Metem,  8206137, 5, InternalConstants.TextCuriousProps, [Personalization.MetemAnnouncer], MetemI); // Some curious props have appeared… What would they possibly be?
    public static readonly BattleTalk TakenOnChampionForm = new BattleTalk(Metem,  8206138, 5, InternalConstants.TextTakenOnChampionForm, [Personalization.MetemAnnouncer], MetemI); // Egads! They’ve taken on the Champion’s form! This bodes ill!
    public static readonly BattleTalk DejaVu = new BattleTalk(Metem,  8206139, 4, InternalConstants.TextDejaVu, [Personalization.MetemAnnouncer], MetemI); // Ah-I’ve got a serious case of deja vu here.
    public static readonly BattleTalk RingRendInTwo = new BattleTalk(Metem,  8206140, 4, InternalConstants.TextRingRendInTwo, [Personalization.MetemAnnouncer], MetemI); // What destructiveness! The ring has been rend in two!
    public static readonly BattleTalk MutationCorrupting = new BattleTalk(Metem,  8206141, 5, InternalConstants.TextMutationCorrupting, [Personalization.MetemAnnouncer], MetemI); // The mutation is…corrupting the champion! Let’s hope they keep it together!
    public static readonly BattleTalk SomethingsComing = new BattleTalk(Metem,  8206142, 3, InternalConstants.TextSomethingsComing, [Personalization.MetemAnnouncer], MetemI); // Something’s coming! Stay on your toes!
    public static readonly BattleTalk WarpedFabric = new BattleTalk(Metem,  8206143, 6, InternalConstants.TextWarpedFabric, [Personalization.MetemAnnouncer, Personalization.President], MetemI); // Woah! What is this place? Did the Lindwurm warp the very fabric of space and time?
    public static readonly BattleTalk AnotherDimension = new BattleTalk(Metem,  8206144, 5, InternalConstants.TextAnotherDimension, [Personalization.MetemAnnouncer], MetemI); // Is this another dimension? I must confess, I am utterly bewildered!
    public static readonly BattleTalk HardPressed = new BattleTalk(Metem,  8206145, 4, InternalConstants.TextHardPressed, [Personalization.MetemAnnouncer], MetemI); // A relentless assault! The Champion is hard-pressed!
    public static readonly BattleTalk FeverPitch = new BattleTalk(Metem,  8206146, 5, InternalConstants.TextFeverPitch, [Personalization.MetemAnnouncer], MetemI); // The battle has reached a fever pitch, but the Champion still stands!
    public static readonly BattleTalk StayStrong = new BattleTalk(Metem,  8206147, 4, InternalConstants.TextStayStrong, [Personalization.MetemAnnouncer], MetemI); // There’s so many of them! Stay strong, I beg you!
    public static readonly BattleTalk NotSureIUnderstand = new BattleTalk(Metem,  8206148, 4, InternalConstants.TextNotSureIUnderstand, [Personalization.MetemAnnouncer], MetemI); // I’m not sure I understand what’s going on anymore, folks!
    public static readonly BattleTalk LeftRealmOfLogic = new BattleTalk(Metem,  8206149, 4, InternalConstants.TextLeftRealmOfLogic, [Personalization.MetemAnnouncer], MetemI); // We appear to have completely left the realm of logic behind!
    public static readonly BattleTalk DefiesComprehension = new BattleTalk(Metem,  8206150, 5, InternalConstants.TextDefiesComprehension, [Personalization.MetemAnnouncer], MetemI); // Something that defies all comprehension is unfolding before our very eyess!
